...
import { updateInfoById } from '../../features/authSlice';
    ...
    <div>
      ...
      <form className='w-[800px] m-5' onSubmit={handleSubmit(onSubmit)}>
               ...
               <div className="mb-6">
                  ...
                  <input {...register('address')} type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder='địa chỉ' />
